function Hero() {
  return (
    <div className=" font-pacifico text-gray-800 flex flex-col items-center gap-4 max-w-6xl mx-auto mb-12 bg-amber-50 p-16 rounded-lg shadow-2xl">
      ...
      <div className="flex flex-row justify-arounditems-center gap-2">
